globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/scule/dist/index.mjs';
import { hash } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/ufo/dist/index.mjs';
import { createStorage } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/T440S/Desktop/b/AppBulider/node_modules/radix3/dist/index.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/src/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"WS_APPS_ADD":"9880/screens","WS_PRODUCTS_UPDATE":"/products","WS_PRODUCTS_GET":"/products","WS_PRODUCTS_LIST":"/products","WS_PRODUCTS_COUNT":"/products","WS_PRODUCTS_DELETE":"/products","WS_EXTRA_FIELDS_LIST":"http://localhost:3000/mock/extrafields.json","WS_PRODUCTS_ADD":"/products/add","public":{"WS_APPS_ADD":"9880/screens","WS_PRODUCTS_UPDATE":"/products","WS_PRODUCTS_GET":"/products","WS_PRODUCTS_LIST":"/products","WS_PRODUCTS_COUNT":"/products","WS_PRODUCTS_DELETE":"/products","WS_EXTRA_FIELDS_LIST":"http://localhost:3000/mock/extrafields.json","WS_PRODUCTS_ADD":"/products/add","DEBUG":"","API":"http://localhost:","API_COMMON":"","REALMS":"StagePFE","AUTH_PATH":"http://localhost:8080/realms/StagePFE","CLIENT_SECRET_KEY":"HeMHHIFbO3IPJygciATbhCcEXp6KQCw7","LOGOUT_REDIRECT_URL":"http://localhost:3000/authentification","CLIENT_ID":"stage","WS_ADD_MEDIA":"8096/api/asset-command/assets/add-asset/"}};
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/T440S/Desktop/b/AppBulider/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\T440S\\Desktop\\b\\AppBulider","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\T440S\\Desktop\\b\\AppBulider\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\T440S\\Desktop\\b\\AppBulider\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\T440S\\Desktop\\b\\AppBulider\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_frAtV8 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_frAtV8, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_frAtV8, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/T440S/Desktop/b/AppBulider/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<link rel=\"icon\" type=\"image/x-icon\" href=\"/favicon.ico?v2\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
