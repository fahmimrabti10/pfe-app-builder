...
component.value.items.coverImageUrl = newValue['Image'][0]['thumbUrl']; }
    ...
    component.value.items.key = newValue['key1'];
    component.value.items.value = newValue['value'];
    component.value.items.value1 = newValue['value1'];
   component.value.items.key1= newValue['key1'];
  },
  { deep: true }
);
...
component.value.items.coverImageUrl[0]['thumbUrl']; }
  ...
  localPayload.value.key1 = component.value.items.key1;
  localPayload.value.value1= component.value.items.value1;
