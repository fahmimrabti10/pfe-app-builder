<template>
  ...
  <a-row class="mb-2">
    <a-col
      ...
      :span="24"
    >
      <a-form-item label="number_of_tickets_available">
        <a-input
          v-model:value="component.number_of_tickets_available"
          size="small"
        />
      </a-form-item>
    </a-col>
  ...
  <a-row class="mb-2">
    ...
    >
      <a-form-item label="title">
        <a-input
          v-model:value="component.items.key"
          size="small"
        />
      </a-form-item>
    </a-col>
