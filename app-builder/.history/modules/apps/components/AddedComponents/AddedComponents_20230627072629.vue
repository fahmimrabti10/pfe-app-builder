...
export default {
  components: {
    ...
    Button, card, templ, element1, story, element2, ratings, carousel, carousel1, carousel2,
    carousel4, card2, descreption,  card3, descreption1, card16
  },
