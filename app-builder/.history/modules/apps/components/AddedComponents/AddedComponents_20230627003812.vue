...
export default {
  components: {
    section, image, story, card13, card14, card15, card10, card11, card1, card5, card7,
    Button, card, templ, element1, story, element2, ratings, carousel, carousel1, carousel2, carousel4, card2, descreption, carousel5, card3, descreption1, card16
  },
