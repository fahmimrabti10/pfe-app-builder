...
const file: any = ref({});
// const headersUpload = { authorization: decodeURIComponent(useNuxtApp().$auth.token), 'x-tenantId': 'tn',
// 'x-lang':useNuxtApp().$i18n.locale.value, 'x-userName' : useLoggedInUserStore().user.data.given_name , }
